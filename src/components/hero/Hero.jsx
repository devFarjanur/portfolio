...
import img from "../../assets/Farjanur Rahman Fahim.jpg"
      ...
      <div className=" container mx-auto pt-5 h-[750px] md:h-[100vh] md:flex-col-reverse sm:h-[780px]  flex sm:flex-col-reverse sm:pt-0 ">
        <div className=" left mt-4 md:mt-0 flex-1 flex flex-col justify-center gap-5 w-1/2 md:w-full md:py-2 sm:py-0">
          <div className="info w-fit flex flex-col items-start justify-center gap-3 sm:gap-2">
            ...
            >
              Hello, I'm Farjanur Rahman Fahim
            </h2>
            <TypeAnimation
              data-aos="fade-up"
              sequence={[
          ...
          <div className="icons flex mt-5">
            ...
            >
              ...
              <li>
                <a href="https://www.facebook.com/profile.php?id=100008361218807&mibextid=ZbWKwL">
                  {" "}
        ...
        <div className="right top-5 flex-1 flex items-center justify-center md:items-end sm:items-end">
          <div className=" relative sm:h-[100%] h-[80%] w-fit flex items-center sm:items-end">
            <img
            data-aos="fade-up"
              className="sm:h-[320px] sm:w-[260px] md:h-[350px] md:w-[270px] mx-auto h-[550px] w-[380px] rounded"
